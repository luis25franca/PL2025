...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','tpc6.py',32),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','tpc6.py',36),
  ('expression -> term','expression',1,'p_expression_term','tpc6.py',40),
  ('term -> term TIMES factor','term',3,'p_term_times','tpc6.py',44),
  ('term -> term DIVIDE factor','term',3,'p_term_divide','tpc6.py',48),
  ('term -> factor','term',1,'p_term_factor','tpc6.py',52),
  ('factor -> NUMBER','factor',1,'p_factor_num','tpc6.py',56),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','tpc6.py',60),
]
